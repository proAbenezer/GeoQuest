// db/schema.ts
import { pgTable, uuid, text, boolean, doublePrecision, timestamp, date, integer, customType, uniqueIndex } from "drizzle-orm/pg-core";
...
export const places = pgTable("places", {
    ...
    parentId: uuid("parent_id").references(() => places.id, {
        onDelete: "cascade",
    }),
...
// --- RECENTLY VISITED ---
export const recentlyVisited = pgTable("recently_visited", {
    id: uuid("id").primaryKey().defaultRandom(),
    userId: uuid("user_id").references(() => users.id, { onDelete: "cascade" }),
    guestId: uuid("guest_id").references(() => guests.id, { onDelete: "cascade" }),
    placeId: uuid("place_id")
...
export const commentVotes = pgTable("comment_votes", {
    ...
    uniqueVotePerUser: uniqueIndex("unique_vote_per_user").on(table.commentId, table.userId),
}));
// ============================================
// RELATIONS
// ============================================
